...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SceneviewLibraryAccessors laccForSceneviewLibraryAccessors = new SceneviewLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>sceneview</b>
     */
    public SceneviewLibraryAccessors getSceneview() {
        return laccForSceneviewLibraryAccessors;
    }
    ...
    public static class ComGoogleLibraryAccessors extends SubDependencyFactory {
        private final ComGoogleArLibraryAccessors laccForComGoogleArLibraryAccessors = new ComGoogleArLibraryAccessors(owner);

        public ComGoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.google.ar</b>
         */
        public ComGoogleArLibraryAccessors getAr() {
            return laccForComGoogleArLibraryAccessors;
        }

    }

    public static class ComGoogleArLibraryAccessors extends SubDependencyFactory {

        public ComGoogleArLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core3</b> with <b>com.google.ar:core</b> coordinates and
         * with version reference <b>comGoogleArCore2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore3() {
            return create("com.google.ar.core3");
        }
    ...
    public static class SceneviewLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public SceneviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getArsceneview() {
            return create("sceneview.arsceneview");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>comGoogleArCore2</b> with value <b>1.48.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComGoogleArCore2() { return getVersion("comGoogleArCore2"); }
